...
// change to Farrenhight
function convert(num){
  let deg = (num - 273.15) * (9/5) +32;
  return deg.toFixed(2);
}

// create function that logs the city entered in the form
function searchCity(){
...
$('#submit-btn').click(function(e) {
  // prevent default stops form from refreshing page // e = event
  e.preventDefault();
  searchCity();
})

// make seearch information appear until they submit a city
